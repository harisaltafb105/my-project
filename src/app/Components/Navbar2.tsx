...
<div className=' h-[100px] flex gap-28 max-lg:gap-3'>
 <div className='ml-6 mt-7 max-md:block md:hidden absolute right-3'> <Sheet>
  ...
  <SheetContent>
    ...
    <div className='ml-[505px] w-[430px] h-[24px] text-base font-medium  max-md:justify-center max-md:items-center max-md:hidden lg:ml-[450px] max-lg:ml-[350px]'>{/*center part*/}
